...
<html>
    <head>
        ...
        <script>
            function validate() {
                ...
                if (name== "" || name == null) {
                    document.getElementById("Application").innerHTML = "Name is required.";
                    return false;
    ...
    <body>
        ...
        <h1>Student Profilee</h1>
        <form name="profile" method="post" action="Application.php" onsubmit="return validate()">
